   ...
   gct_(config.getParameter<edm::InputTag>("l1GctSums"))
{
   ...
   et_had_ = fs->make<TH1D>("et_had", "HTT;HTT [GeV]", 500, 0., 2000.);
   et_miss_ = fs->make<TH1D>("et_miss", "ETM;ETM [GeV]", 500, 0., 2000.);
   et_tot_ = fs->make<TH1D>("et_tot", "ETT;ETT [GeV]", 500, 0., 2000.);
}
