...
# process.load('SimGeneral.MixingModule.mix_E7TeV_Ave25_25ns_PoissonOOTPU_cfi')
process.load('SimGeneral.MixingModule.mix_E8TeV_AVE_10_BX_50ns_cfi')
...
process.generator = cms.EDProducer("FlatRandomPtGunProducer",
    ...
    psethack = cms.string('single nu pt 10'),
    AddAntiParticle = cms.bool(True),
    firstRun = cms.untracked.uint32(1)
)

process.mix.input.fileNames = cms.untracked.vstring(
    ['/store/mc/Summer11/MinBias_TuneD6T_7TeV-pythia6/GEN-SIM/START311_V2-v1/0036/D4036929-6364-E011-863A-001A92810AA0.root'])
